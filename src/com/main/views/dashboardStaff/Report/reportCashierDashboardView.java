...
public class reportCashierDashboardView extends contentPanel {
    ...
    public reportCashierDashboardView(dashboardStaffView parentView) {
        super();
    ...
    private void setPosition() {
        headerLabel = new textLabel("Data Transaction Report", 40, 0, 300, 80);
    ...
    private void loadTransactionReport() {
        try (Connection conn = connectionDatabase.getConnection()) {
            ...
            String reportPath = "/com/main/report/reportDataTransaction.jasper";

            // Ambil report dari classpath
            java.io.InputStream reportStream = getClass().getResourceAsStream(reportPath);

            if (reportStream == null) {
               parentView.showFailedPopUp("File report Data Transaction Not Found.");
                return;
            }
            ...
            ex.printStackTrace();
            parentView.showFailedPopUp("Gagal memuat report Data Transaction: " + ex.getMessage());
        }
    }
    ...
    private void printReport() {
        ...
        try {
            ...
            java.awt.FileDialog fileDialog = new java.awt.FileDialog((java.awt.Frame) null, "Simpan Laporan Data Transaction", java.awt.FileDialog.SAVE);
            
            // Default nama file
            fileDialog.setFile("Data_Transaction_Report.pdf");
           ...
           parentView.showSuccessPopUp("Laporan Data Transaction berhasil disimpan:\n" + fileToSave.getAbsolutePath());
