...
public class loadDataKriteria {
    ...
    public static DefaultTableModel getAllDataBobotKriteriaNormalisasi() {
        String[] dataHeader = { "ID", "Kriteria", "Bobot", "Normalisasi", "Hasil" };
        DefaultTableModel tm = new DefaultTableModel(null, dataHeader);
    ...
    public static String getTotalResultKriteriaText() {
        ...
        try (Connection conn = connectionDatabase.getConnection();
            ...
            totalText = "      " + String.format("%.2f", totalResult);
    ...
    public static int getTotalKriteria() {
        String query = "SELECT COUNT(*) FROM tbl_data_kriteria";
        ...
        try (Connection conn = connectionDatabase.getConnection();
            ...
            if (rs.next()) {
                return rs.getInt(1); // jumlah data
            }
